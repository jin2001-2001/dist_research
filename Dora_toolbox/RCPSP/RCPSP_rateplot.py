...
plt.plot(x2_vals, y2_vals, 'o', color =(0.3, 0.5, 1.0, 0.4), markersize=2)  
smoothed = lowess(y2_vals, x2_vals, frac=0.1)
plt.plot(smoothed[:, 0], smoothed[:, 1], color='blue', linewidth=2, label='30 sec bound trend')
...
plt.ylabel('ratio: objective/lowerbound')
plt.title('ratio vs. # of tasks')
plt.grid(True)
plt.tight_layout()
plt.show()

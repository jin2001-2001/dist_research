...
def test_stramline(ratio1=0,ratio2=0,ratio3=0,
    ...
    #call RCPSP solver:
    start_T = time.time()
    model, result = cj.RCPSP_solver("./scratch/scratchtest_graph.mm", t = 8)
...
def dora_best_MM(
    ...
    for j in range(len(score_list)):
        ...
        subtasksfb = mbatchsize*4+2    
        subtasksg = mbatchsize*4*4+2
        percentage = 0
...
if __name__ == "__main__":
    ...
    seq = [1024, 768, 1024+768+256] ## should be a list
    ...
    set_list = ["2630"]*0 +["4060"]*0+ ["4050"]*0+ ["A40"]*0 + ["CameraINT8"]*4 + ["Samsung"]*0 + ["V100"]*0 + ["Xiaomi"]*0
